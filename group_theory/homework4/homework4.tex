...
We show that the Klein-four group is a normal subgroup of $S_4$. 
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        (mn)^{-1} \in MN$
        \item \textbf{Closure} Given $mn, m'n' \in MN \implies g^{-1}mng, g^{-1}m'n'g \in MN$. Therefore
        $(g^{-1}mng)(g^{-1}m'n'g) = g^{-1}(mnm'n')g \implies mnm'n' \in MN$
    \end{itemize}
